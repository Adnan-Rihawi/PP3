...
<details>
    ...
    Der LaTeX‑Compiler erzeugt mehrere Dateien. Die wichtigste ist die PDF‑Datei. Zusätzlich entstehen Hilfsdateien wie .aux, .log und manchmal .out. Diese Dateien     werden automatisch erstellt, damit LaTeX interne Informationen speichern kann.
</details>

<details>
    <summary>How do you change the name of the pdf-file?</summary>
    Der Name der PDF‑Datei wird über den Parameter -jobname festgelegt. Wenn man -jobname=example.pdf angibt, heißt die Ausgabe „example.pdf“, egal wie die             .tex‑Datei heißt.
</details>
...
<details>
    ...
    Die PDF bekommt ein anderes Layout. Die Klasse book fügt automatisch Kapitelstrukturen hinzu, verändert die Seitenränder, nutzt andere Schriftgrößen und            beginnt neue Kapitel standardmäßig auf einer rechten Seite. Das Dokument wirkt dadurch wie ein Buch und nicht wie ein Artikel.
</details>
<details>
    <summary>What changes in your pdf, if you add <code>\section{Intro}</code> after <code>\maketitle</code></summary>
    Es wird eine neue Abschnittsüberschrift mit dem Titel „Intro“ erzeugt. Diese erscheint direkt unter dem Titelblatt und wird automatisch nummeriert. Außerdem        wird sie in das Inhaltsverzeichnis aufgenommen, falls eines existiert.
</details>
...
<details>
 ...
 Der Text wird nicht mehr als normaler Absatz dargestellt, sondern als große Überschrift. <h1> ist die größte Überschriftstufe in HTML und wird deutlich größer und  fett angezeigt.
</details>

<details>
    <summary>How can you generate a listing of items?</summary>
    <code>
    Man kann entweder eine ungeordnete Liste oder eine geordnete Liste erstellen.
    Eine ungeordnete Liste verwendet Aufzählungspunkte.
    Eine geordnete Liste verwendet Nummern.
    </code>
</details>
...
<details>
    ...
    <code>
    Eine Tabelle wird mit einem Tabellen‑Element aufgebaut. Sie besteht aus Zeilen und Zellen. Die Kopfzeile wird mit speziellen Zellen markiert, und darunter          folgen die normalen Datenzellen.
    </code>
</details>
